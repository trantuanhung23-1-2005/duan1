	...
	<main class="wrapper sb-default ecom">
		...
		<div class="cr-main-content">
            ...
            <tr>
                ...
                <td><?= $category["name"] ?></td>
                <td>
                    <a href="?role=admin&act=editCategory&id=<?= $category['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
                    <a href="?role=admin&act=deleteCategory&id=<?= $category['id'] ?>" onclick="return confirm('Are you sure?')" class="btn btn-danger btn-sm">Delete</a>
                </td>
            </tr>
        <?php endforeach; ?>
		</tbody>
