								...
								<div class="row cr-product-uploads">
									<div class="col-lg-14">
										<div class="cr-vendor-upload-detail">
											<form action="<?= BASE_URL ?>?role=admin&act=edit-post-product&id=<?= $_GET['id'] ?>" method="post" enctype="multipart/form-data" class="row g-3">
												<div class="col-md-6">
													<label for="name" class="form-label">Product name</label>
													<input type="text" class="form-control slug-title" id="name" name="name" value="<?= $product->name ?>">
												</div>
												<div class="col-md-12">
                          ...
                          <?php
                            ...
                            <?php endforeach; ?>
												...
												<div class="col-md-12">
													...
													<textarea class="form-control" rows="2" id="description" name="description" value="<?= $product->description ?>"></textarea>
												</div>
												<div class="col-md-12">
