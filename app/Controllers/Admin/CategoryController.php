<?php
    ...
    class CategoryController {
        ...
        public function listCategory() {
            ...
            include "app/Views/Admin/categories/category_list.php";
        }
        ...
        public function addCategory() {
            ...
            include "app/Views/Admin/categories/category_add.php";
        }
        ...
        public function editCategory(){
            ...
            if ($id) {
                ...
                include "app/Views/Admin/categories/category_edit.php";
            } else {
